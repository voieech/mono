...
<template>
  <div>
    <div
      :class="
        twMerge(
          'w-full rounded-full border border-zinc-200 bg-zinc-50 p-4 shadow-lg select-none',
          showPlayer && 'rounded-2xl shadow-none',
        )
      "
    >
      <div
      ...
      >
        ...
        <div class="flex w-full flex-row items-center justify-between">
          ...
          <svg
            class="h-4 w-4 shrink-0 text-yellow-400 transition duration-150"
            :class="{
